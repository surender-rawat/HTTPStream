...
public class MainApp {
    ...
    private static void testAnyOf() throws InterruptedException, ExecutionException {
        ...
        System.out.println("All combined Futures result>> " + future0.get() + " | " + future1.get() + " | " + future2.get());
    }
    ...
    private static void testAllOf() throws InterruptedException, ExecutionException {
        ...
        CompletableFuture<Void> result = CompletableFuture.allOf(future0, future1, future2);
        result.get();
        ...
        return CompletableFuture.supplyAsync(new Supplier<String>() {
            ...
            public String get() {
                try {
                    ...
                    System.out.println("inside future: done..." + index);
